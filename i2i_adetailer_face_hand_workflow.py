...
def i2i_adetailer_face_hand_workflow(
        t2i_model_name,
        prompt,
        negative_prompt,
        face_prompt,
...
if __name__ == "__main__":
    ...
    for i in range(2):
        i2i_adetailer_face_hand_workflow(model_name,  params["prompt"], params["negative_prompt"], params["prompt"], params["prompt"], images)
